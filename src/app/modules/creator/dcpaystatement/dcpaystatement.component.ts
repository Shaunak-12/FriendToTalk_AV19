...
@Component({
  ...
  imports: [TitleHeaderComponent,AdvanceTableComponent,AdvanceTablePaginatorComponent, AddStatementComponent,StatusPageComponent,
...
export class DcpaystatementComponent implements OnInit, OnDestroy {
  ...
  allPageData: { TotalCount: number, [key: string]: any; DCPageId: any;StatusId : any;}[] = [];
