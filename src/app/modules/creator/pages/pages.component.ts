...
@Component({
  selector: 'app-pages',
  imports: [TitleHeaderComponent,AdvanceTableComponent,AdvanceTablePaginatorComponent, AddPageComponent,StatusPageComponent,
...
export class PagesComponent implements OnInit, OnDestroy {
  ...
  allPageData: { TotalCount: number; CreatedDateTZ?: string; StatusId: number; DCPageId: number; Name: string; DCPageName: string; Handle: string; Mobile: string; CreatedDate?: string }[] = [];
